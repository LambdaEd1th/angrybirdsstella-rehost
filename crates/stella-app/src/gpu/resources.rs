//! Texture upload, capture target, pipeline layout, and recovered blend-state helpers.
...
pub(super) fn create_capture_texture(
    device: &wgpu::Device,
    label: &str,
...
pub(super) fn straight_blend() -> wgpu::BlendState {
    wgpu::BlendState {
        color: wgpu::BlendComponent {
